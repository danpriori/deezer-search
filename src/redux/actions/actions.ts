...
import { SET_ARTISTS, SET_SEARCH_INPUT, SET_CURRENT_SELECTION_INDEX, SET_ALBUM_LIST, SET_CURRENT_ARTIST_SELECTED, SET_CURRENT_ALBUM_SELECTED, SET_CURRENT_ALBUM_DETAILS, SET_ALBUM_LIST_RESULT_TEXT } from './actionTypes';
